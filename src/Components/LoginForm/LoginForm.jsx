...
const AuthPage = () => {
  ...
  return (
    <div className='lg-div'>
        ...
        <h2>{isRegistering ? 'Login' : 'Register'}</h2>
        ...
        <div className='btn-main'>
            ...
            {isRegistering ? 'New User? Create Account.':'Already have an account? Login here.'}
            </p>
            <button type="submit">{isRegistering ? 'Login' : 'Register'}</button>
